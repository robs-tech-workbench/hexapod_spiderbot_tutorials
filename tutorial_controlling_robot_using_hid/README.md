Read the companion tutorial on [Catch IT](https://catchit.pl/): [Controlling a Hexapod with a HID Gamepad](https://catchit.pl/blog/controlling-a-hexapod-with-a-hid-gamepad/).
